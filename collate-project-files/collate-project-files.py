...
def build_parser():
    ...
    parser.add_argument('--project',  help="Replace 'x_project_id' with this value",type=str)
    parser.add_argument('--screen', help="Replace 'screen' field with this value",type=str)
