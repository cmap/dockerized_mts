---
params:
  data_dir: "/Users/shiker/Documents/trouble_shoot/cps007_dmc_bms/CPS007_DMC_BMS/CPS011/BMS-I1"
  comp: "BMS-I1"
...
write.csv(df, file.path(lineage_enrichment_path, 'lineage_enrichment_boxplot_dat.csv'), row.names=FALSE)
```
...
# and type of gene mutation (dam, hs, other, wildtype) 
  ...
  plot_data <- top_muts %>%
    dplyr::left_join(DRC %>% dplyr::distinct(ccle_name, auc)) %>% 
...
for (feat in corr_feats) {
  ...
  print(paste("feature", feat, "length", nrow(df)))
  ...
  print(paste("feature", feat, "length_q_lt0.1", nrow(plot_df)))
  ...
  if (nrow(plot_df) > 0) {
    ...
    # outpath = '/Users/anup/work/1_Projects/Portal/report_files_by_plot/correlation_analysis/'
    # write.csv(plot_df, sprintf("%s%s_volcano_plot_data.csv", outpath, feat))
    
    feat_plot_dfs[[li]] = plot_df
    li = li + 1
    
    print(paste("feature", feat, "length_filtered", nrow(plot_df)))
