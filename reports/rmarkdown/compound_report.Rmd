...
Next, for each log2-Viability at a dose, log2-AUC, and log2-IC50 we train and fit multivariate models using the molecular characterizations and genetic dependencies of the PRISM cell lines. The resulting importance of various features can be used to suggest potential biomarkers of compound response or to inform potential hypotheses for mechanisms of action. As with the continuous analyses, features may appear in the table or on the plot multiple times for different "doses" (note that dose can also refer to log2-AUC or log2-IC50).
