...
The second plot shows the AUC of the combination versus the AUC of each constituent for each cell line. Points that fall below the diagonal are more sensitive to the constituent and points that fall above the diagonal are more sensitive to the combination. Only points with AUC values in both conditions are shown.
