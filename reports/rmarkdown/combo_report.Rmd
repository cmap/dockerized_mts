...
solo_lfc <- dplyr::anti_join(LFC, combo_lfc, c("rid", "ccle_name", "culture", "pool_id", "pert_iname", "pert_id", "pert_dose", "pert_idose", "pert_plate", "pert_vehicle", "pert_time", "pert_type", "sig_id", "x_project_id", "LFC", "LFC_cb"))
...
if (nrow(combos) < 1) {
  ...
  for (i in 1:nrow(combos)) {
    volcano_combo <- highlight_key(features_ge %>% dplyr::inner_join(combos[i,], c("added_compounds", "pert_iname")),
