---
params:
  data_dir: '/Users/shiker/Documents/reports/CPS06_CORSELLO/CPS06_CORSELLO/CPS008/BAY-204_LCL-161'
  comp: 'BAY-204_LCL-161'
  qc_path: '/Users/shiker/Documents/reports/CPS06_CORSELLO/CPS06_CORSELLO/data/CPS06_CORSELLO_QC_TABLE.csv'
output:
  html_document:
    toc: false
    theme: paper
...
#spread_lfc %<>% dplyr::mutate(dr_diff = LFC_cb + dr)
...
#spread_lfc %<>% dplyr::mutate(flag = (dr_diff < 1) & (S < 0)) # ifelse((dr_diff < 1 & S < 0), 1, 0)) # if LFC_cb values is within a range of 1 of dr and s < 0 assign flag value of 1 (could be noise)
...
dt <- DT::datatable(spread_lfc_table, style="bootstrap", options = list(lengthChange = FALSE, width = "100%", paging = TRUE, dom = "tp"), colnames = c("Cell Line", "Culture", "Varied Compound | Anchor Compound", "Varied Dose | Anchor Dose", "Synergy", "Dynamic Range", "Artificial Antagonism Flag", "q"), selection = "single", filter = "top")%>%
