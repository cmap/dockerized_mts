---
params:
  data_dir: ~/Desktop/cps005_validation_compounds/CPS005_VALIDATION_COMPOUNDS/CPS007/O6-BENZYLGUANINE_TEMOZOLOMIDE
  comp: "O6-BENZYLGUANINE_TEMOZOLOMIDE"
  qc_path: "~/Desktop/cps005_validation_compounds/CPS005_VALIDATION_COMPOUNDS/data/CPS005_VALIDATION_COMPOUNDS_QC_TABLE.csv"
output:
  html_document:
    toc: false
    theme: paper
...
for (i in 1:nrow(combos)) {
  ...
  p <- plot_ly(synergy_plot) %>%
    ...
    layout(xaxis = list(title = "Synergy score", range = c(min_s, max_s)),
           yaxis = list(title = "-log10(q-value)", range = c(0, max_q)),
