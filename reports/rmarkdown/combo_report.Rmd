---
params:
  data_dir: '/Users/anup/work/1_Projects/CPS_in_Datawarehouse/cps009_kymera/CPS009_KYMERA/PCPS019/PRC-007236969-390-78_PRC-005665489-117-89'
  comp: 'PRC-007236969-390-78_PRC-005665489-117-89'
  qc_path: '/Users/anup/work/1_Projects/CPS_in_Datawarehouse/cps009_kymera/CPS009_KYMERA/data/CPS009_KYMERA_QC_TABLE.csv'
output:
  html_document:
    toc: false
    theme: paper
...
dt <- DT::datatable(spread_lfc_table, style="bootstrap", extensions = 'Buttons', options = list(lengthChange = FALSE, width = "100%", paging = TRUE, dom = 'Blfrtip', buttons = c('copy', 'csv', 'excel', 'pdf', 'print'), lengthMenu = list(c(10,25,50,-1), c(10,25,50,"All"))), colnames = c("Cell Line", "Culture", "Varied Compound | Anchor Compound", "Varied Dose | Anchor Dose", "Synergy", "Dynamic Range", "Artificial Antagonism Flag", "q"), selection = "single", filter = "top")%>%
  ...
  export_spread_lfc <- spread_lfc %>% dplyr::mutate(neg_log10_qval = -log10(q)) %>% dplyr::select(ccle_name, culture, pert_iname, pert_dose, S, dr, flag, q, neg_log10_qval)
...
write.csv(df, file.path(random_forest_path, 'combo_random_forest_models.csv'), row.names=FALSE)
```