...
Additionally, the table includes a mean synergy score for each combination dose response curve. Synergy score is in terms of LFC, therefore the mean synergy score is as follows:

$$log(\frac{1}{n}\sum_{i=1}^n2^{s_{i}}) $$ 
...
for (comp in varied_comps) {
  ...
  dt <- DT::datatable(compounds_all, style="bootstrap",
                      ...
                      colnames = c("Compound", "Cell Line", "Culture", "Added compounds", "Added doses", "a", "EC50", "s", "b", "AUC", "IC50", "ID", "Average Synergy Score"),
                      rownames = FALSE,
